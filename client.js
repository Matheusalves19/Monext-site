...
// Validação de sessão (somente usuário e senha)
...
document.getElementById("btnAdicionarCliente").addEventListener("click", () => {
  ...
  if (clientes.some(c => c.cpf === cpfSomenteNumeros)) {
...
function editarCliente(id) {
  ...
  if (clientes.some(c => c.cpf === cpfSomenteNumeros && c.id !== id)) {
    alert("Outro cliente com este CPF já cadastrado!"); return;
  }
